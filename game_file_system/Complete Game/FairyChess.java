...
//====================================PRINT====================================	
	public static void printBoard(char[][] board)//from array information
	{
		...
		StdDraw.textLeft(815, 290, "MOUSE_INPUT+(C,M,S)");
		}
		...
		{	
			...
			for(int j=0;j<imax;j++)
			{
				...
				case 'p':StdDraw.picture(x,y,"GUI/BPawn.png",60,60);
					break;
				case 'd':StdDraw.picture(x,y,"GUI/BDrunkenSoldier.png",60,60);
					break;
			...
			case 'P':StdDraw.picture(x,y,"GUI/WPawn.png",60,60);
				break;
			case 'D':StdDraw.picture(x,y,"GUI/WDrunkenSoldier.png",60,60);
				break;
...
boardDir=selectedFile2.getAbsolutePath();
